...
function Update() {
  ...
  useEffect(() => {
    const fetchRecipe = async () => {
      try {
        const response = await axios.get(`https://recipie-manager-backend.onrender.com/recipes/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.put(`https://recipie-manager-backend.onrender.com/recipes/${id}`, formattedData, {
            headers: { 
