...
export const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://recipie-manager-backend.onrender.com/recipes/");
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
        try {
            ...
            const response = await axios.get("https://recipie-manager-backend.onrender.com/favorites", {
  ...
  const toggleFavorite = async (recipeId) => {
    try {
        ...
        const response = await axios.post("https://recipie-manager-backend.onrender.com/favorites/toggle", 
            { recipeId }, 
            { headers: { Authorization: `Bearer ${token}` } }
        );
